...
import 'cooking_tutorial_screen.dart'; // Ajoutez cette ligne pour importer le tutoriel
  ...
  List<TutorialStep> _getTutorialSteps() {
    return [
      TutorialStep(
        ...
        description: 'Rassemblez tous les ingrédients nécessaires pour la recette.',
        imageUrl: 'https://example.com/image1.jpg',
      ),
      TutorialStep(
        title: 'Cuisson',
        description: 'Mélangez et faites cuire les ingrédients selon la recette.',
        imageUrl: 'https://example.com/image2.jpg',
      ),
      TutorialStep(
        title: 'Finition',
        description: 'Ajoutez les garnitures et servez chaud.',
  ...
  FloatingActionButton startCookingAndFavoriteButton(FavoriteProvider provider) {
    return FloatingActionButton.extended(
      ...
      onPressed: () {
        ...
        List<TutorialStep> tutorialSteps = _getTutorialSteps();

        // Naviguer vers le CookingTutorialScreen
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CookingTutorialScreen(tutorialSteps: tutorialSteps),
          ),
        );
      },
      label: Row(
